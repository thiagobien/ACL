...
1. [Gathering Facts](1_Gathering_Facts)
1. [Fork GitHub Repositories](2_Fork_GitHub_Repositories)
1. [Deploy Docker Registry](3_Deploy_Docker_Registry)
1. [Deploy Jenkins](4_Deploy_Jenkins)
